...
import views.AnswerQuestionView;
import views.BrowseForumView;
import views.BrowseGameView;
import views.ExampleView;
import views.FAQPageView;
import views.PlayGameView;
import views.LoginPageView;
import views.TestForm;
import views.PublishGameView;
import views.ReportIssueView;
import views.SubmitQuestionView;
...
//		ExampleView exampleDynamicPage = new ExampleView(databaseInterface,fileStoreInterface);
		...
		PlayGameView playGamePage = new PlayGameView(databaseInterface, fileStoreInterface);
		BrowseGameView browse = new BrowseGameView(databaseInterface,fileStoreInterface);
		LoginPageView loginPage = new LoginPageView(databaseInterface, fileStoreInterface);
		PublishGameView lab6Page = new PublishGameView(databaseInterface, fileStoreInterface);
		ReportIssueView reportIssue = new ReportIssueView(databaseInterface, fileStoreInterface);
		HelpPageView helpPage = new HelpPageView(databaseInterface, fileStoreInterface);
		FAQPageView faqPage = new FAQPageView(databaseInterface, fileStoreInterface);
		SubmitQuestionView submitQuestion = new SubmitQuestionView(databaseInterface, fileStoreInterface);
		BrowseForumView forum = new BrowseForumView(databaseInterface, fileStoreInterface);
		AnswerQuestionView answer = new AnswerQuestionView(databaseInterface, fileStoreInterface);
...
//		        else
		        ...
		        } else if (playGamePage.process(toProcess)) {
		        	
		        }
		        else if (lab6Page.process(toProcess)) {
		        	
		        }
		        else if (browse.process(toProcess)) {
		        	
		        } 
		        else if (helpPage.process(toProcess)) {
		        ...
		        else if (reportIssue.process(toProcess)) {
		        	
		        }
		        else if (faqPage.process(toProcess)) {

		        }
		        else if (submitQuestion.process(toProcess)) {

		        }
		        else if (forum.process(toProcess)) {

		        }
		        else if (answer.process(toProcess)) {
